package com.project.subwate_backend.user.presentation.controller;
...
public class UserManageController {
    ...
    public ResponseDto<UserResponseDto> join(@RequestBody @Validated UserInfoDto userInfoDto) {
        return ResponseDto.of(UserResponseCode.USER_JOIN_SUCCESS, userManageService.join(userInfoDto));
    }
