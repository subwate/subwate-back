...
class SubwayLineControllerTest {
        ...
        @BeforeEach
        void setUp() {
                subwayLineDto = new SubwayLineDto(1001L, "1호선");
                subwayLineDtoList = Arrays.asList(
                                new SubwayLineDto(1001L, "1호선"),
                                new SubwayLineDto(1002L, "2호선"));
        }
        ...
        void testGetSubwayLine() throws Exception {
                ...
                result.andExpect(status().isOk())
                                ...
                                .andExpect(jsonPath("$.data.subwayLineName").value("1호선"));
        }
        ...
        void testGetSubwayLineList() throws Exception {
                ...
                result.andExpect(status().isOk())
                                .andExpect(jsonPath("$.httpStatus").value("OK"))
                                .andExpect(jsonPath("$.data[0].subwayLineName").value("1호선"))
                                .andExpect(jsonPath("$.data[1].subwayLineName").value("2호선"));
        }
}
