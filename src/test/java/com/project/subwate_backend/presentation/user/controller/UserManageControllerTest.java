...
import com.project.subwate_backend.user.application.service.UserManageService;
...
import com.project.subwate_backend.user.presentation.controller.UserManageController;
...
class UserManageControllerTest {
    ...
    void givenUserLoginDto_WhenJoin_ThenSuccess() throws Exception {
        ...
        ResponseDto<UserResponseDto> mockResponse = ResponseDto.of(UserResponseCode.USER_JOIN_SUCCESS, mockUserResponseDto);
        ...
        mockMvc.perform(post("/api/v1/user/join")
                ...
                .andExpect(jsonPath("$.message", is(UserResponseCode.USER_JOIN_SUCCESS.getMessage())))
